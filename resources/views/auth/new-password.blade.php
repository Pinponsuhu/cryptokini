...
<body class="bg-white">
    <div class="w-80 md:w-96 mx-auto mt-20 rounded-md shadow-md px-6 py-14">
        ...
        <p>Enter the pin sent to your email address</p>
        <form action="" method="post">
            @csrf
            <div class="mb-3 mt-4">
                <label for="" class="font-bold block mb-2">Pin</label>
                <input type="email" class="p-3 rounded-md block w-full border-2 border-indigo-600 outline-indigo 600" placeholder="Pin:">
            </div>
